        			...
        			<table width="100%">
			   		...
			   		<table width="100%">
			   			<tr>
			   				...
			   				<td width="5%">$</td>
			   				<td width="34%" style="text-align:center;"> <div class="mototal">112.00</div> </td>
			   			</tr>	
        ...
        <div class="gst_asste"> 
        		...
        		<table width="100%">
        				...
        				<tr>
        					...
        					<td width="55%">Sales Taxes (12%)</td>
        					<td width="5%">$</td>
        					<td width="35%" style="text-align:center;"><div class="rmosale">10.71</div></td>
        				</tr>	
        		</table>	
			   		<table width="100%">
			   			<tr>
			   				...
			   				<td width="5%">$</td>
			   				<td width="34%"style="text-align:center;"><div class="rmototal">89.29</div> </td>
			   			</tr>	
